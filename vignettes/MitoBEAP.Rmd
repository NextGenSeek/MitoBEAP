...
This creates All_Ontarget_mean_Coverage.csv in the ./Overview directory. CreateOverview() generates the combined summary table and, by default, retains the intermediate output directories (minimum, Coverage, mean, OnTarget, and percentages). If these intermediate files are no longer required, they can be removed automatically after the summary table is generated by running CreateOverview(cleanup = TRUE).
